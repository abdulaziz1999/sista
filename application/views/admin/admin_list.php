            ...
            <div class='col-xs-12'>
              <div class='box'>
                <div class='box-header'>
                  <h3 class='box-title'>ADMIN LIST <?php echo anchor('pengguna/create/','Create',array('class'=>'btn btn-success btn-sm'));?>
		<?php echo anchor(site_url('admin/pdf'), '<i class="fa fa-file-pdf-o"></i> PDF', 'class="btn btn-warning btn-sm"'); ?></h3>
                </div><!-- /.box-header -->
                <div class='box-body'>
