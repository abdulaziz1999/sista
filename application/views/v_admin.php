										...
										<div class="col-sm-md-12" style="margin-bottom: 50px;">
												<div class="container" style="margin-left: 0px;">
														<div class="col-sm-4 bg-primary text-center">
															...
															<h1><strong><?php $date = date('Y-m-d'); echo $this->db->get_where('tb_issuing_item',['waktu' => $date])->num_rows();?></strong></h1>
															<br>
														...
														<div class="col-sm-4 bg-primary text-center">
															...
															<h1><strong><?php $date = date('Y-m-d'); echo $this->db->get_where('tb_receiving_item',['waktu' => $date])->num_rows();?></strong></h1>
															<br>
